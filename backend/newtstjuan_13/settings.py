"""
Django settings for newtstjuan_13 project.
...
ROOT_URLCONF = 'newtstjuan_13.urls'
...
WSGI_APPLICATION = 'newtstjuan_13.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "newtstjuan Support <support@newtstjuan-13.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newtstjuan_13 API",
    "DESCRIPTION": "API documentation for newtstjuan_13 App",
    "VERSION": "v1",
}
